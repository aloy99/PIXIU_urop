...
TASK_REGISTRY = {
    ...
    "faireval_fpb": flare.FairevalFPB,
    "faireval_fiqasa": flare.FairevalFIQASA,
    "faireval_headlines": flare.FairevalHeadlines,
    "faireval_ner": flare.FairevalNER,
    "faireval_finqa": flare.FairevalFinQA,
    "faireval_convfinqa": flare.FairevalConvFinQA,
    "faireval_sm_bigdata": flare.FairevalStockMovementBigData,
    "faireval_sm_acl": flare.FairevalStockMovementACL,
    "faireval_sm_cikm": flare.FairevalStockMovementCIKM,
    "flare_fpb": flare.FPB,
